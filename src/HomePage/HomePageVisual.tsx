...
export const HomePageVisual: React.FunctionComponent = () => {
    ...
    function radioButton(selected) {
        return selected ? (
            <FontAwesomeIcon size="lg" icon={regular("circle")} style={{ cursor: "pointer" }} />
        ) : (
            <FontAwesomeIcon size="lg" icon={regular("circle-dot")} />
        );
    }
    const greenGradient = [
        "#1EC074",
    ...
    return (
        <div className="home-page-body-visual">
            ...
            <div className="image-container">
                <img src={selfNoBg} alt="Anna Mola" className="image"></img>
